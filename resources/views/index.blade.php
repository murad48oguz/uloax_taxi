...
@extends('menu')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <a href="{{route('taxi_order')}}"><div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="image_1"><img src="{{url('images/img-1.png')}}"></div></a>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="input_main">
              <div class="container">
                <a href="{{route('taxi_order')}}"><h1 class="request_text">Go to taxi order page</h1></a>
                <a href="{{route('taxi_order')}}"><form action="/action_page.php">
                ...
                <div class="send_bt"><a href="{{route('taxi_order')}}">SEARCH</a></div>
          </div>
          </div>
      ...
      <div class="container">
          <div class="footer_section_2">
            <div class="row">
                ...
                <div class="image-icon"><img src="{{url('images/fb-icon.png')}}"><span class="fb_text"><a href="#">Facebook</a></span></div>
                <div class="image-icon"><img src="{{url('images/twitter-icon.png')}}"><span class="fb_text"><a href="#">Twitter</a></span></div>
                <div class="image-icon"><img src="{{url('images/in-icon.png')}}"><span class="fb_text"><a href="#">Linkedin</a></span></div>
                <div class="image-icon"><img src="{{url('images/youtube-icon.png')}}"><span class="fb_text"><a href="#">Youtube</a></span></div>
                <div class="image-icon"><img src="{{url('images/instagram-icon.png')}}"><span class="fb_text"><a href="#">Instagram</a></span></div>
                </div>
          <div class="col-sm-6 col-md-6 col-lg-3">
